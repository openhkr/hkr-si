...
@Data
@ApiModel
public class PaymentRechargeParameter {
    @ApiModelProperty(position = 1, required = true, value = "业务订单号")
    @NotBlank
    @Length(min = 1, max = 64, message = "订单id最长支持64位")
    private String orderId;
    @ApiModelProperty(position = 2, required = true, value = "业务订单类型，8 租车保证金余额,16 普通余额")
    @NotBlank
    @Pattern(regexp = "[8]|16", message = "业务订单类型只包括8,16")
